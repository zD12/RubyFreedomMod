...
public class Command_suspend extends TFM_Command
{
    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.adminAction(sender.getName(), "Casting a complete hell over " + player.getName(), true);
        ...
        TFM_Util.bcastMsg("You're suspend and bye Bitch!", ChatColor.RED);
        ...
        {
            TFM_Util.adminAction(sender.getName(), "Aboloshing " + player.getName() + " from the superadmin list.", true);
